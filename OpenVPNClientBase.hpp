...
// and TunBuilderBase.
#ifndef OPEN_VPN_CLIENT_BASE_H
#define OPEN_VPN_CLIENT_BASE_H
#include <string>
#include <vector>
#include <utility>
...
namespace libopenvpn
{
	...
	class OpenVPNClientBase : public openvpn::TunBuilderBase,			  // expose tun builder virtual methods
							  public LogReceiver,						  // log message notification
							  public openvpn::ExternalTun::Factory,		  // low-level tun override
							  public openvpn::ExternalTransport::Factory, // low-level transport override
							  public openvpn::ExternalPKIBase
	{
	public:
		OpenVPNClientBase(){};
		...
		//TunClientFactory* new_tun_factory(const Config& conf, const OptionList& opt);
		...
		virtual bool remote_override_enabled() = 0;
		virtual void remote_override(RemoteOverride &) = 0;
	...
	protected:
		...
		virtual void connect_attach() = 0;
		virtual void connect_pre_run() = 0;
		virtual void connect_run() = 0;
		virtual void connect_session_stop() = 0;

		virtual openvpn::Stop *get_async_stop() = 0;
	...
	private:
		...
		static void parse_config(const Config &, EvalConfig &, openvpn::OptionList &);
		...
		OpenVPNClientBase(const OpenVPNClientBase &) = delete;
		OpenVPNClientBase &operator=(const OpenVPNClientBase &) = delete;
	};
